export default {
    ...
    statistic: "Statistic",
    share_analytics: "Sharing",
    share_analytics_info: "When you enable sharing, you will be provided with a link or sharing code. You can use this link or code to grant other persons or systems access to the analytics of this website. You can stop sharing or renew the sharing code at any time.",
    tracking_code: "Tracking-Code",
    website_share_key: "Share Key",
    website_renew_share_key: "generate new code",
    website_renew_share_key_info: "If you renew the code, the current link and code will no longer work. Please keep in mind to update the link/code everywhere it is used. Do you want to continue?",
