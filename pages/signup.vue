    ...
    <v-container fluid class="full-height pt-8">
        ...
        <v-card outlined width="450" class="mx-auto pa-3">
            ...
            <v-card-text class="pb-3">
                ...
                <nuxt-link to="/login" class="text-decoration-none">Sign in</nuxt-link>
            </v-card-text>
